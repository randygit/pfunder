...
exports.updateProfile = function(req,res) {
    ...
    console.log('Inside updateProfile req.body.password :' + req.body.name);  
    ...
    */
    ...
    User.find({ 'email': req.params.email, verified: true }, function(err,user) {
        ...
        if (user.length == 1) {
            ...
            // validUser.profile_pic = pictureUrl;
